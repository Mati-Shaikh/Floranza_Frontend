    ...
    const contacts = [
      {
        ...
        title: '+92 306 2829000',
        description: 'Frances ensures seamless product ordering with unmatched efficiency and reliability.'
      },
      {
        icon: (
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: 'floranzafragrance@gmail.com',
        description: 'Frances ensures seamless product ordering with unmatched efficiency and reliability.'
      },
      {
        icon: (
